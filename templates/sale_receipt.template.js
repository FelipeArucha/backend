// Devuelve HTML profesional para comprobante de venta
module.exports = function saleReceiptTemplate({ sale, client, details, businessInfo }) {
  return `
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;margin:0 auto;font-family:Arial,sans-serif;background:#fff;color:#222;padding:24px;border:1px solid #eee;">
    <tr>
      <td>
        ...
        <div style="font-size:20px;font-weight:bold;text-align:center;margin:16px 0 12px 0;">Comprobante de venta</div>
        ...
        <div style="margin-top:24px;text-align:center;font-size:13px;color:#888;">Gracias por su compra</div>
      </td>
    </tr>
  </table>
  `
